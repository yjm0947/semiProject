        ...
        <div id="content">
         ...
         <div id="book">
            ...
            <div id="book_2">
                ...
                <table >
                    <tr id="num">
                        <td rowspan="4" style="width: 150px; height: 250px;"><img src="<%=contextPath + p.getTitleImg() %>" style="border: 1px solid rgb(204, 204, 204);" alt="" width="135px" height="200px" id="imgthumb">
