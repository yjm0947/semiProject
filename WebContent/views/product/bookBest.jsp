...
<body>
	<%@include file = "../common/header.jsp" %>
        ...
        <div id="content">
         <div id="con_1">
            <p id="con_title">베스트 도서 목록</p>
            <p id="con_subtitle">파란서점의 판매 순위 Top30</p>
         </div>
         <div id="con_menu">
         ...
         <div id="list_menu">
            ...
            <div id="list_num"><!-- 페이징 처리 -->
                ...
                <%if(pi.getCurrentPage()!=1) {%>
                	<button type="button" onclick="location.href='<%=contextPath %>/book.be?currentPage=<%=pi.getCurrentPage()-1 %>'">&lt;</button>
                <%} %>
                
                <%for(int i=pi.getStartPage(); i<=pi.getEndPage(); i++) {%>
                	<%if(i!=pi.getCurrentPage()) {%>
                		<button type="button" onclick="location.href='<%=contextPath%>/book.be?currentPage=<%=i%>';"><%=i %></button>
                	<%}else {%>
