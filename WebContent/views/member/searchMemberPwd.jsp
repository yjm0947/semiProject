...
<body>
    ...
    <div class="outer">
        <form action="<%=contextPath %>/findpwd.me" method="post">
            ...
            <div class="loginBox" style="margin-top:0px; display:none; margin-bottom:150px;">
            ...
            <button type="button" class ="btn btn-secondary" style="padding: 12px; width:400px;" data-bs-toggle="modal" data-bs-target="#staticBackdrop" id="btn">확인</button>
        </div><!-- Modal -->
        </form>    
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        PASSWORD &nbsp; : &nbsp; <font id="defart" style="color:crimson; font-size:16px;">""</font>
      </div>
