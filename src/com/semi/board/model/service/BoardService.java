...
public class BoardService {
	...
	//공지사항 총 게시물 수
	public int selNoticeAdminCount() {
		
		Connection conn = JDBCTemplate.getConnection();
		
		int listcount = new BoardDao().selNoticeAdminCount(conn);
	...
	//공지사항 키워드 검색 리스트
	public ArrayList<Board> searchNoticeAdmin(int num, String search) {
		
		Connection conn = JDBCTemplate.getConnection();
		
		ArrayList<Board> list = new BoardDao().searchNoticeAdmin(conn,num,search);
